...
/* ---- Frame pacing ---- */
/* ~4 frames at 120fps: covers the at-risk frame plus settle, then releases.
 * Up-rate 0 self-recovers a cluster in <1 frame, so a longer hold only pins
 * unsaturated clusters as heat -- the boost must stay transient. */
